...
text = File.read("book_example.txt")
text.gsub!("\n", ' ')
sentences = text.split(/[.|!|?]/)
sentences_length = []
sentences.each do |sentence|
  sentences_length << sentence.split.size
end
longest_sentence_index = sentences_length.index(sentences_length.max)

p sentences[longest_sentence_index]
p sentences_length.max
